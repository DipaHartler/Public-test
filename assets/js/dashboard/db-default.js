(function ($) {
	...
	var myChart = new Chart(ctx, {
		type: 'roundedBar',
		data: {
			labels: ["Trips", "Hotels", "Vactions", "Activities"],
			datasets: [{
				label: 'Reservations',
	...
	$(document).ready(function(){
		...
		$("#selectedDateRange").append("<span>(" + $('#daterange').val() + ")</span>");
		$(".chartFiltersToggle").click(function(){
			$(this).toggleClass("active")
			$(this).parents(".widget-header").next(".widget-body").find(".chartFilters").toggleClass("active");
		})
	})
